                ...
                if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(phoneCode)) {
                    ...
                    if(match==true) {
                        if (phoneCode.equals(realCode)) {
                            ...
                            intent2.setAction("com.example.loginandregister.MainActivity");
                            Bundle bundle = new Bundle();
                            bundle.putString("login", mEtRegisteractivityUsername.getText().toString());
                            bundle.putString("password", mEtRegisteractivityPassword2.getText().toString());
